# Generated by Django 4.2.13 on 2024-06-29 14:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relationship', models.CharField(choices=[('single', 'Холост'), ('in_a_rel', 'В отношениях'), ('engaged', 'Помолвлен(а)'), ('married', 'Женат/Замужем'), ('in_love', 'Влюблен(а)'), ('complicated', 'Все сложно')], max_length=20, verbose_name='Статус отношений')),
